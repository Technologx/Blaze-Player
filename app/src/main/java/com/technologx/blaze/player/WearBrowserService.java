...
import com.technologx.blaze.player.dataloaders.AlbumLoader;
import com.technologx.blaze.player.dataloaders.AlbumSongLoader;
import com.technologx.blaze.player.dataloaders.ArtistAlbumLoader;
import com.technologx.blaze.player.dataloaders.ArtistLoader;
import com.technologx.blaze.player.dataloaders.ArtistSongLoader;
import com.technologx.blaze.player.dataloaders.PlaylistLoader;
import com.technologx.blaze.player.dataloaders.PlaylistSongLoader;
import com.technologx.blaze.player.dataloaders.SongLoader;
import com.technologx.blaze.player.models.Album;
import com.technologx.blaze.player.models.Artist;
import com.technologx.blaze.player.models.Playlist;
import com.technologx.blaze.player.models.Song;
    ...
    private void addMediaRoots(List<MediaBrowser.MediaItem> mMediaRoot) {
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "technologx.blaze.player/drawable/ic_empty_music2"))
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "technologx.blazeplayer/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "technologx.blaze.player/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "technologx.blaze.player/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "technologx.blaze.player/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
