...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "technologx.blaze.player.donate_1";
    private static final String DONATION_2 = "technologx.blaze.player.donate_2";
    private static final String DONATION_3 = "technologx.blaze.player.donate_3";
    private static final String DONATION_5 = "technologx.blaze.player.donate_5";
    private static final String DONATION_10 = "technologx.blaze.player.donate_10";
    private static final String DONATION_20 = "technologx.blaze.player.donate_20";
